...
const Gallery: React.FC = () => {
  ...
  // Spring physics for high-end "weighted" feel
  ...
  const titleY = useTransform(smoothProgress, [0, 0.15], [0, -100]);
  const bgTextX = useTransform(smoothProgress, [0, 1], [150, -450]);

  return (
    <section 
      ref={targetRef} 
      className="relative h-[600vh] bg-[#7E4950]"
    >
